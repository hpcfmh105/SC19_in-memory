...
while [ $dim1 -le 4096 ]
do
  	echo "Welcome $nnode, $napp1, $napp2, $napp3, $jobid times"
	sed "s/\${nnode}/${nnode}/g;s/\${napp1}/${napp1}/g;s/\${napp2}/${napp2}/g;s/\${trans}/${trans}/g;s/\${napp3}/${napp3}/g;s/\${dim1}/${dim1}/g;s/\${dim2}/${dim2}/g" laplace_decaf_titan_var.job  > testnewjob
