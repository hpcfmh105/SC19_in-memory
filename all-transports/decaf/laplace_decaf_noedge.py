...
# --- Graph definition ---
# --- Graph definition ---
laplace   = wf.Node("prod", start_proc=0, nprocs=procs_prod, func='prod', cmdline=os.environ['BUILD_DIR'] + '/bin/laplace_out')
...
con   = wf.Node("con", start_proc= procs_prod, nprocs=procs_con, func='con', cmdline=os.environ['BUILD_DIR'] + '/bin/laplace_in') 
...
wf.processGraph("laplace_decaf_noedge", args.custom_args)
