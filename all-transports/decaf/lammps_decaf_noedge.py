...
# --- Graph definition ---
# --- Graph definition ---
lammps   = wf.Node("prod", start_proc=0, nprocs=procs_prod, func='prod', cmdline=os.environ['BUILD_DIR'] + '/bin/lammps_out')
...
con   = wf.Node("con", start_proc= procs_prod, nprocs=procs_con, func='con', cmdline=os.environ['BUILD_DIR'] + '/bin/lammps_in') 
...
wf.processGraph("lammps_decaf_noedge", args.custom_args)
