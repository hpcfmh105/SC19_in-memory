...
mod_path = os.environ['BUILD_DIR'] + '/lib/libmod_lammps_decaf_shared.so'
...
# --- Graph definition ---
# --- Graph definition ---
lammps   = wf.Node("prod", start_proc=0, nprocs=procs_prod, func='prod', cmdline=os.environ['BUILD_DIR'] + '/bin/lammps_decaf')
outPort = lammps.addOutputPort("out")

#print1   = wf.Node("dflow", start_proc=procs_prod, nprocs=procs_link, func='print', cmdline='./lammps')
#inPort1  = print1.addInputPort("in")

con   = wf.Node("con", start_proc= procs_prod+procs_link, nprocs=procs_con, func='con', cmdline=os.environ['BUILD_DIR'] + '/bin/lammps_decaf') 
inPort  = con.addInputPort("in")


link    = wf.Edge(lammps.getOutputPort("out"), con.getInputPort("in"), start_proc=procs_prod, nprocs=procs_link, func='dflow',  path=mod_path, prod_dflow_redist='count', dflow_con_redist='count', cmdline=os.environ['BUILD_DIR'] +'/bin/lammps_decaf')
